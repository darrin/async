(function (global, factory) {
     ...
     * }]);
     */
    function autoInjectReturnResults(tasks, callback) {
        var newTasks = {};
    ...
    var argsRegex$1 = /^function\s*[^\(]*\(\s*([^\)]*)\)/m;

    function parseParams$1(func) {
        return func.toString().match(argsRegex$1)[1].split(/\s*\,\s*/);
    }
    ...
    * time.
    ...
    var index = {
        ...
        asyncify: asyncify,
        auto: auto,
        autoInjectReturnResults: autoInjectReturnResults,
    ...
    exports.auto = auto;
    exports.autoInjectReturnResults = autoInjectReturnResults;
